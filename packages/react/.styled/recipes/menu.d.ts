...
type MenuSlot = "root" | "item" | "arrow" | "trigger" | "context" | "content" | "arrow-tip" | "indicator" | "item-text" | "item-group" | "positioner" | "item-group" | "radio-item" | "separator" | "trigger-item" | "checkbox-item" | "item-indicator" | "context-trigger" | "item-group-label" | "radio-item-group"
